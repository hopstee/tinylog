...
import { bm as writable, aG as state, g as get$1, V as set$1, aF as tick, br as settled } from "./DilKp9Ls.js";
import { o as onMount } from "./D39b7Q4Q.js";
class HttpError {
  /**
   * @param {number} status
...
const base = ((_a = globalThis.__sveltekit_updql8) == null ? void 0 : _a.base) ?? "";
const assets = ((_b = globalThis.__sveltekit_updql8) == null ? void 0 : _b.assets) ?? base ?? "";
const version = "1769700162839";
...
async function start(_app, _target, hydrate) {
  ...
  if ((_a2 = globalThis.__sveltekit_updql8) == null ? void 0 : _a2.data) {
    globalThis.__sveltekit_updql8.data;
  }

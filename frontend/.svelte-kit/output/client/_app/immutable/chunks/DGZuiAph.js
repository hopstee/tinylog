...
import { aM as state, g as get$1, O as set$1, aL as tick, ba as settled } from "./BaP1QAji.js";
import { w as writable } from "./BYda1gcW.js";
import { o as onMount } from "./BB252WvV.js";
class HttpError {
  /**
   * @param {number} status
...
const base = ((_a = globalThis.__sveltekit_au4fn8) == null ? void 0 : _a.base) ?? "";
const assets = ((_b = globalThis.__sveltekit_au4fn8) == null ? void 0 : _b.assets) ?? base ?? "";
const version = "1769446769512";
...
async function start(_app, _target, hydrate) {
  ...
  if ((_a2 = globalThis.__sveltekit_au4fn8) == null ? void 0 : _a2.data) {
    globalThis.__sveltekit_au4fn8.data;
  }
